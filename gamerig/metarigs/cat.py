...
def create(obj):
    ...
    arm.collections[-1].gamerig.group = 4
    arm.collections.new("Fore Fingers.L")
    arm.collections[-1].gamerig.row = 5
    arm.collections[-1].gamerig.group = 6
    arm.collections.new("Fore Fingers.R")
    arm.collections[-1].gamerig.row = 5
    arm.collections[-1].gamerig.group = 6
    arm.collections.new("Hind Fingers.L")
    arm.collections[-1].gamerig.row = 6
    arm.collections[-1].gamerig.group = 6
    arm.collections.new("Hind Fingers.R")
    arm.collections[-1].gamerig.row = 6
    arm.collections[-1].gamerig.group = 6
    arm.collections.new("Fore.L (IK)")
    arm.collections[-1].gamerig.row = 7
    arm.collections[-1].gamerig.group = 2
    arm.collections.new("Fore.L (FK)")
    arm.collections[-1].gamerig.row = 8
    arm.collections[-1].gamerig.group = 5
    arm.collections.new("Fore.R (IK)")
    arm.collections[-1].gamerig.row = 7
    arm.collections[-1].gamerig.group = 2
    arm.collections.new("Fore.R (FK)")
    arm.collections[-1].gamerig.row = 8
    arm.collections[-1].gamerig.group = 5
    arm.collections.new("Hind.L (IK)")
    arm.collections[-1].gamerig.row = 10
    arm.collections[-1].gamerig.group = 2
    arm.collections.new("Hind.L (FK)")
    arm.collections[-1].gamerig.row = 11
    arm.collections[-1].gamerig.group = 5
    arm.collections.new("Hind.R (IK)")
    arm.collections[-1].gamerig.row = 10
    arm.collections[-1].gamerig.group = 2
    arm.collections.new("Hind.R (FK)")
    arm.collections[-1].gamerig.row = 11
    arm.collections[-1].gamerig.group = 5
    arm.collections.new("Tail (IK)")
    arm.collections[-1].gamerig.row = 13
    arm.collections[-1].gamerig.group = 4
    arm.collections.new("Tail (FK)")
    arm.collections[-1].gamerig.row = 13
    arm.collections[-1].gamerig.group = 4
    ...
    bone = arm.edit_bones.new('palm.001.L')
    ...
    bones['palm.001.L'] = bone.name
    bone = arm.edit_bones.new('palm.002.L')
    ...
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['r_toe.L']]
    bones['palm.002.L'] = bone.name
    bone = arm.edit_bones.new('palm.003.L')
    ...
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['r_toe.L']]
    bones['palm.003.L'] = bone.name
    bone = arm.edit_bones.new('palm.004.L')
    ...
    bone = arm.edit_bones.new('tail.006')
    bone.head[:] = 0.0000, 0.4028, 0.2303
    bone.tail[:] = 0.0000, 0.4543, 0.2321
    bone.roll = 0.0000
    bone.use_connect = True
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['tail.005']]
    bones['tail.006'] = bone.name
    ...
    bone = arm.edit_bones.new('index.001.L')
    bone.head[:] = 0.0215, 0.1367, 0.0087
    bone.tail[:] = 0.0217, 0.1325, 0.0070
    bone.roll = -0.3427
    bone.use_connect = False
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['palm.001.L']]
    bones['index.001.L'] = bone.name
    bone = arm.edit_bones.new('middle.001.L')
    bone.head[:] = 0.0311, 0.1358, 0.0117
    bone.tail[:] = 0.0324, 0.1297, 0.0092
    bone.roll = -1.0029
    bone.use_connect = False
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['palm.002.L']]
    bones['middle.001.L'] = bone.name
    bone = arm.edit_bones.new('ring.001.L')
    bone.head[:] = 0.0376, 0.1372, 0.0117
    bone.tail[:] = 0.0389, 0.1311, 0.0092
    bone.roll = -1.0029
    bone.use_connect = False
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['palm.003.L']]
    bones['ring.001.L'] = bone.name
    bone = arm.edit_bones.new('pinky.001.L')
    bone.head[:] = 0.0466, 0.1444, 0.0083
    bone.tail[:] = 0.0476, 0.1412, 0.0074
    bone.roll = -1.7551
    bone.use_connect = False
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['palm.004.L']]
    bones['pinky.001.L'] = bone.name
    ...
    bone = arm.edit_bones.new('index.002.L')
    bone.head[:] = 0.0217, 0.1325, 0.0070
    bone.tail[:] = 0.0221, 0.1271, 0.0038
    bone.roll = -0.2465
    bone.use_connect = True
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['index.001.L']]
    bones['index.002.L'] = bone.name
    bone = arm.edit_bones.new('middle.002.L')
    bone.head[:] = 0.0324, 0.1297, 0.0092
    bone.tail[:] = 0.0343, 0.1210, 0.0039
    bone.roll = -0.7479
    bone.use_connect = True
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['middle.001.L']]
    bones['middle.002.L'] = bone.name
    bone = arm.edit_bones.new('ring.002.L')
    bone.head[:] = 0.0389, 0.1311, 0.0092
    bone.tail[:] = 0.0407, 0.1229, 0.0042
    bone.roll = -0.7479
    bone.use_connect = True
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['ring.001.L']]
    bones['ring.002.L'] = bone.name
    bone = arm.edit_bones.new('pinky.002.L')
    bone.head[:] = 0.0476, 0.1412, 0.0074
    bone.tail[:] = 0.0494, 0.1351, 0.0032
    bone.roll = -0.8965
    bone.use_connect = True
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['pinky.001.L']]
    bones['pinky.002.L'] = bone.name
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Tail (IK)'].assign(pbone)
    try:
    ...
    try:
        ...
        pass
    try:
        pbone.gamerig.fk_bone_collection = "Tail (FK)"
    except AttributeError:
        pass
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind.L (IK)'].assign(pbone)
    try:
    ...
    try:
        ...
        pass
    try:
        pbone.gamerig.fk_bone_collection = "Hind.L (FK)"
    except AttributeError:
        pass
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind.R (IK)'].assign(pbone)
    try:
        pbone.gamerig.name = "limbs.paw"
    except AttributeError:
        pass
    try:
        ...
        pass
    try:
        pbone.gamerig.fk_bone_collection = "Hind.R (FK)"
    except AttributeError:
        pass
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Fore.L (IK)'].assign(pbone)
    try:
        pbone.gamerig.name = "limbs.paw"
    except AttributeError:
        pass
    try:
        pbone.gamerig.fk_bone_collection = "Fore.L (FK)"
    except AttributeError:
        pass
    try:
        pbone.gamerig.footprint_bone = "JIG-f_heel.L"
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Fore.R (IK)'].assign(pbone)
    try:
        pbone.gamerig.name = "limbs.paw"
    except AttributeError:
        pass
    try:
        pbone.gamerig.fk_bone_collection = "Fore.R (FK)"
    except AttributeError:
        pass
    try:
        ...
        pass
    pbone = obj.pose.bones[bones['palm.001.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind Fingers.R'].assign(pbone)
    try:
        pbone.gamerig.name = "palm"
    except AttributeError:
        pass
    pbone = obj.pose.bones[bones['palm.002.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind Fingers.R'].assign(pbone)
    pbone = obj.pose.bones[bones['palm.003.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind Fingers.R'].assign(pbone)
    pbone = obj.pose.bones[bones['palm.004.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind Fingers.L'].assign(pbone)
    try:
        pbone.gamerig.name = "palm"
    except AttributeError:
        pass
    ...
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind.R (IK)'].assign(pbone)
    pbone = obj.pose.bones[bones['tail.006']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    ...
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Fore.R (IK)'].assign(pbone)
    pbone = obj.pose.bones[bones['index.001.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    ...
    try:
        ...
        pass
    pbone = obj.pose.bones[bones['middle.001.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    ...
    try:
        ...
        pass
    pbone = obj.pose.bones[bones['ring.001.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    ...
    try:
        ...
        pass
    pbone = obj.pose.bones[bones['pinky.001.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    ...
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Fore.R (IK)'].assign(pbone)
    pbone = obj.pose.bones[bones['index.002.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind Fingers.R'].assign(pbone)
    pbone = obj.pose.bones[bones['middle.002.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind Fingers.R'].assign(pbone)
    pbone = obj.pose.bones[bones['ring.002.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Hind Fingers.R'].assign(pbone)
    pbone = obj.pose.bones[bones['pinky.002.L']]
    pbone.lock_location = (False, False, False)
    pbone.lock_rotation = (False, False, False)
    pbone.lock_rotation_w = False
    pbone.lock_scale = (False, False, False)
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Fore Fingers.R'].assign(pbone)
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    arm.collections['Fore Fingers.L'].assign(pbone)
