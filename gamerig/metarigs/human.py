...
def create(obj):
    ...
    bone.tail[:] = 0.0447, -0.0819, 1.6085
    bone.roll = 0.0415
    bone.use_connect = False
    bone.use_deform = True
    bone.parent = arm.edit_bones[bones['head']]
    ...
    bone.head[:] = 0.0447, -0.0819, 1.6085
    bone.tail[:] = 0.0149, -0.0811, 1.6310
    bone.roll = 2.2482
    bone.use_connect = True
    bone.use_deform = True
    ...
    bone.head[:] = 0.0149, -0.0811, 1.6310
    bone.tail[:] = 0.0139, -0.0952, 1.5999
    bone.roll = 0.0997
    bone.use_connect = True
    bone.use_deform = True
    ...
    bone.head[:] = 0.0139, -0.0952, 1.5999
    bone.tail[:] = -0.0000, -0.1176, 1.6016
    bone.roll = 1.7754
    bone.use_connect = True
    bone.use_deform = True
